...
export type ParticipantFormSchema = z.ZodObject<{
  ...
  rsvp_status: z.ZodOptional<z.ZodEnum<['attending', 'declined', 'maybe', 'pending']>>
}>
...
export interface FormFieldConfig<T = unknown> {
  name: string
  label: string
  type: 'text' | 'email' | 'tel' | 'password' | 'number' | 'date' | 'file' | 'select' | 'textarea' | 'checkbox'
  placeholder?: string
  required?: boolean
  disabled?: boolean
  readonly?: boolean
...
export interface FormValidator<TFormData = Record<string, BaseFormField>> {
  ...
  validateField: (field: keyof TFormData, value: unknown, data: TFormData) => string | null
  schema?: z.ZodSchema
}

// Custom validation functions
export type CustomValidator<T = unknown> = (value: T) => boolean | string | Promise<boolean | string>
...
export const createStringField = (value = '', required = false): StringFormField => ({
  value,
  touched: false,
  dirty: false,
  validated: false,
...
export const createNumberField = (value: number | null = null, required = false): NumberFormField => ({
  value,
  touched: false,
  dirty: false,
  validated: false,
...
export const createDateField = (value: Date | null = null, required = false): DateFormField => ({
  value,
  touched: false,
  dirty: false,
  validated: false,
...
export const createFileField = (value: File | null = null, required = false): FileFormField => ({
  value,
  touched: false,
  dirty: false,
  validated: false,
...
export const createArrayField = <T>(value: T[] = [], required = false): ArrayFormField<T> => ({
  value,
  touched: false,
  dirty: false,
  validated: false,
