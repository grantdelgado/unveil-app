...
export interface EnhancedHookResult<TData = unknown, TError = DomainErrorUnion> {
...
export interface AuthHookResult extends BaseHookResult<{
...
// Event Hook Types
export interface EventDetailsHookResult extends BaseHookResult<{
...
export interface ParticipantHookResult extends BaseHookResult<EventParticipantWithUser[]> {
  participants: EventParticipantWithUser[]
  hosts: EventParticipantWithUser[]
  guests: EventParticipantWithUser[]
  totalCount: number
  inviteParticipant: (eventId: string, phone: string, role?: string) => Promise<MutationResult<EventParticipant>>
  updateParticipant: (participantId: string, updates: Partial<EventParticipant>) => Promise<MutationResult>
...
export interface MessagingHookResult extends BaseHookResult<MessageWithSender[]> {
...
export interface RealtimeHookResult<TData = unknown> extends BaseHookResult<TData[]> {
  data: TData[]
  isConnected: boolean
...
export interface PaginatedHookResult<TData = unknown> extends BaseHookResult<TData[]> {
  data: TData[]
...
export interface FilterableHookResult<TData = unknown, TFilters = Record<string, unknown>> 
...
export interface CachedHookResult<TData = unknown> extends BaseHookResult<TData> {
...
export interface OptimisticHookResult<TData = unknown> extends BaseHookResult<TData[]> {
  data: TData[]
...
export type AsyncHookFactory<TParams, TResult> = (params: TParams) => Promise<TResult>
