...
export default function GuestEventHomePage() {
      ...
      <div className="min-h-screen bg-app flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          <h1 className="text-2xl font-semibold text-stone-800 mb-2">
            We couldn&apos;t find this celebration
          </h1>
  ...
  return (
    <div className="min-h-screen bg-app">
      {/* Header */}
      <div
        className={`sticky top-0 z-40 bg-app/95 backdrop-blur-sm border-b border-stone-200/50 transition-all duration-300 ${
        ...
        <div className="max-w-5xl mx-auto px-6 transition-all duration-300">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1
                  className={`font-semibold text-stone-800 transition-all duration-300 tracking-tight ${
